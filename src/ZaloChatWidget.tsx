  ...
  return (
    <div style={{ position: "fixed", bottom: "clamp(16px, 3vw, 24px)", right: "clamp(16px, 3vw, 24px)", zIndex: 9999, fontFamily: "'Aeonik', 'Inter', sans-serif" }}>
      ...
      {isOpen && (
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "14px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
              ...
              <div>
                ...
                <span style={{ fontSize: "12px", color: "#10B981", fontWeight: "500" }}>🟢 Online — Tư vấn khóa học Video BĐS</span>
              </div>
            </div>
            <button
          ...
          <p style={{ margin: "0 0 16px", fontSize: "13.5px", color: "#94A3B8", lineHeight: "1.5" }}>
            Bạn cần tư vấn về khóa học BĐS offline? Chat trực tiếp với mình qua Zalo nhé!
          </p>
      ...
      {showTooltip && !isOpen && (
        ...
        >
          <span>💬 Tư vấn khóa học Video BĐS (0934.688.632)</span>
          <button
            onClick={(e) => {
              e.stopPropagation();
              setShowTooltip(false);
